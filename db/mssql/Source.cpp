	...
	if (r == SQL_SUCCESS || r == SQL_SUCCESS_WITH_INFO)
	{
		...
		if (r == SQL_SUCCESS || r == SQL_SUCCESS_WITH_INFO)
		{
			...
			if (r == SQL_SUCCESS || r == SQL_SUCCESS_WITH_INFO)
			{
				...
				const char* name = "subscriptionms"; // им€ ODBC-соединени€, настроенного в Windows
				...
				if (r == SQL_SUCCESS || r == SQL_SUCCESS_WITH_INFO)
				{
					...
					if (r == SQL_SUCCESS || r == SQL_SUCCESS_WITH_INFO)
					{
						...
						const char* sql = "create table publication_type(id int IDENTITY PRIMARY KEY ,type varchar(50) NOT NULL );";
						...
						const char* sql1 = "create table publication(id int IDENTITY PRIMARY KEY ,pub_index int NOT NULL ,type_id int NOT NULL FOREIGN KEY REFERENCES publication_type(id),name varchar(50) NOT NULL ,price int NOT NULL CHECK (price > 0));";
						...
						const char* sql2 = "create table subscriber(id int IDENTITY PRIMARY KEY ,surname varchar(50) NOT NULL , name varchar(50) NOT NULL ,patronymic varchar(50) NULL ,address varchar(50) NOT NULL , number varchar(50) NOT NULL );";
						...
						const char* sql3 = "create table ticket(id int IDENTITY PRIMARY KEY , subscriber_id int NOT NULL FOREIGN KEY REFERENCES subscriber(id),publication_id int NOT NULL FOREIGN KEY REFERENCES publication(id),subscription_term int NOT NULL CHECK (subscription_term > 0),month int NOT NULL CHECK (month > 0 AND month < 13),year int NOT NULL CHECK (year > 1990 AND year < 2021));";
