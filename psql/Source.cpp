	...
	if (r == SQL_SUCCESS || r == SQL_SUCCESS_WITH_INFO)
	{
		...
		if (r == SQL_SUCCESS || r == SQL_SUCCESS_WITH_INFO)
		{
			...
			if (r == SQL_SUCCESS || r == SQL_SUCCESS_WITH_INFO)
			{
				...
				const char* name = "subscriptionp"; // им€ ODBC-соединени€, настроенного в Windows
				...
				if (r == SQL_SUCCESS || r == SQL_SUCCESS_WITH_INFO)
				{
					...
					if (r == SQL_SUCCESS || r == SQL_SUCCESS_WITH_INFO)
					{
						...
						const char* sql = "create table publication_type(id serial NOT NULL primary key , type character varying(50) NOT NULL);";
						//cout << "create table publication_type(id serial NOT NULL primary key , type character varying(50) NOT NULL);" << endl;
						...
						const char* sql1 = "create table publication(id serial NOT NULL primary key ,pub_index integer NOT NULL , type_id integer NOT NULL REFERENCES publication_type(id),name character varying(50) NOT NULL , price integer NOT NULL CHECK (price > 0));";
						...
						const char* sql2 = "create table subscriber (id serial NOT NULL primary key ,surname character varying(50) NOT NULL , name character varying(50) NOT NULL ,patronymic character varying(50) NULL ,address character varying(50) NOT NULL , number character varying(50) NOT NULL);";
						...
						const char* sql3 = "create table ticket( id serial NOT NULL primary key , subscriber_id integer NOT NULL REFERENCES subscriber(id), publication_id integer NOT NULL REFERENCES publication(id),subscription_term integer NOT NULL CHECK (subscription_term > 0),month integer NOT NULL CHECK (month > 0 AND month < 13),year integer NOT NULL CHECK (year > 1990 AND year < 2021));";
						...
						const char* sql5 = "insert into publication (id, pub_index, type_id, name, price) values  (1, 751396, 2, 'Komsomolskaya Pravda in Belarus', 95) ,(2, 673876, 3, 'Belarus today', 93) ,(3, 600071, 3, 'Arguments and facts in Belarus', 43) ,(4, 405539, 1, 'From hand to hand', 79) ,(5, 352808, 1, 'Antenna', 74) ,(6, 35296, 1, 'Republic', 41) ,(7, 133567, 3, 'Peoples newspaper', 11) ,(8, 935908, 2, 'Banner of youth', 38) ,(9, 235412, 3, 'Star', 20) ,(10, 981841, 3, 'Vitbichi', 57) ;";
						...
						cout << endl;
						cout << "¬рем€ выполнени€: " << (end_time - start_time) / 1000.0 << endl;
